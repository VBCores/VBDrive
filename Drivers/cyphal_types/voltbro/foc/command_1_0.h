...
// Source file:   /Users/igor/Work/misc/cyphal_ws/types/voltbro/foc/command.1.0.dsdl
// Generated at:  2025-07-15 15:58:59.695556 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     python_build:  ('main', 'Feb  4 2025 14:51:09')
//     python_compiler:  Clang 16.0.0 (clang-1600.0.26.6)
//     python_revision:
//     python_xoptions:  {}
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/Users/igor/Work/misc/cyphal_ws/types/voltbro/foc/command.1.0.dsdl is trying to use a serialization library that was compiled with "
...
#define voltbro_foc_command_1_0_EXTENT_BYTES_                    20UL
#define voltbro_foc_command_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 20UL
    ...
    voltbro_foc_command_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.si.unit.torque.Scalar.1.0 torque
    {
        ...
        const int8_t _err10_ = uavcan_si_unit_torque_Scalar_1_0_deserialize_(
            &out_obj->_torque, &buffer[offset_bits / 8U], &_size_bytes5_);
        if (_err10_ < 0)
        {
            return _err10_;
        }
    ...
    // uavcan.si.unit.angle.Scalar.1.0 angle
    {
        ...
        const int8_t _err11_ = uavcan_si_unit_angle_Scalar_1_0_deserialize_(
            &out_obj->angle, &buffer[offset_bits / 8U], &_size_bytes6_);
        if (_err11_ < 0)
        {
            return _err11_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 angle_kp
    {
        ...
        const int8_t _err13_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->angle_kp, &buffer[offset_bits / 8U], &_size_bytes8_);
        if (_err13_ < 0)
        {
            return _err13_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 velocity_kp
    {
        ...
        const int8_t _err14_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->velocity_kp, &buffer[offset_bits / 8U], &_size_bytes9_);
        if (_err14_ < 0)
        {
            return _err14_;
        }
