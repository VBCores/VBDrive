...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(INDUCT_EN_GPIO_Port, INDUCT_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DRV_WAKE_GPIO_Port, DRV_WAKE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI3_CS_GPIO_Port, SPI3_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : INDUCT_EN_Pin */
  GPIO_InitStruct.Pin = INDUCT_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(INDUCT_EN_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : DRV_READY_Pin DRV_FAULT_Pin */
  GPIO_InitStruct.Pin = DRV_READY_Pin|DRV_FAULT_Pin;
  ...
  /*Configure GPIO pin : IND_IT_Pin */
  GPIO_InitStruct.Pin = IND_IT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IND_IT_GPIO_Port, &GPIO_InitStruct);
